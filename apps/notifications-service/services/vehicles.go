 ...
 */
func GetVehiclesHashMap(myHashMap *map[string][]types.Vehicle) {
...
/**
  ...
  * The hashmap is used to retrieve vehicles by pattern Id.
*/
func getVehiclesHashMap() (map[string][]types.Vehicle, error) {
	...
	vehicleHashMap := make(map[string][]types.Vehicle)
...
*/
func getVehicles() ([]types.Vehicle, error) {
	vehicles := []types.Vehicle{}

	// Make a GET request to the URL
	url :=  "https://api.carrismetropolitana.pt/v2/vehicles" //os.Getenv("")
